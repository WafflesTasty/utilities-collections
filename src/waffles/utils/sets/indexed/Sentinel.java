...
import waffles.utils.sets.utilities.indexed.Indexed;
...
public class Sentinel<O> implements Indexed, IndexedSet<O>
{
	...
	/**
	 * Returns a value from the {@code Sentinel}.
	 * Coordinates are assumed to be relative to the
	 * index of the {@code Sentinel}, i.e. the zero
	 * coordinate returns the center of
	 * the {@code Sentinel}.
	 * 
	...
	{		
		...
		{
			iBuffer[i] = crds[i] + len;
			int l = Integers.abs(crds[i]);
